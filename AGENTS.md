...
- Follow `docs/EDITOR_ARCHITECTURE.md` for the normative contract and `docs/EDITOR_SOURCE_FIDELITY_AUDIT.md` for current compliance gaps. Do not restate partial editor invariants in feature-specific documentation.
