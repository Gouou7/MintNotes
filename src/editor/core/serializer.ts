...
// md configuration
// Mint Notes never synthesizes escapes. A backslash in canonical Markdown is
// always user-authored and is preserved by the parser.
const mdEscapeInline = (ch: string): string => ch;
const mdEscapeBlockStart = (ch: string): string => ch;
